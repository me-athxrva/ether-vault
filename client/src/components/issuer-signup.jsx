    ...
    <Card className="py-0 relative rounded-none border-none bg-transparent shadow-none ring-0" {...props}>
      ...
      <CardContent className="px-0 bg-transparent">
        <form>
          <FieldGroup>
            <Field>
              <FieldLabel htmlFor="name">Organisation</FieldLabel>
              <Input id="name" type="text" placeholder="Your Organisation Name" required className="rounded-[5px] border-white/10 focus:border-white/50" />
            </Field>
            <Field>
            ...
            <FieldGroup>
              <Field>
                ...
                <FieldDescription className="text-center">
                  Already have an account? <Link href="/issuer/login">Sign in</Link>
                </FieldDescription>
              </Field>
            </FieldGroup>
          </FieldGroup>
