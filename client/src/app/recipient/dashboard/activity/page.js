...
export default function RecipientActivityPage() {
  ...
  const {
    ...
    loading,
    error,
  } = useDashboardData("/api/dashboard/recipient/activity", {
  ...
  const sidebarData = {
    navMain: [
      ...
      { title: "My Documents", url: "/recipient/dashboard/documents", icon: <FileTextIcon /> },
      { title: "Activity", url: "/recipient/dashboard/activity", icon: <ActivityIcon />, isActive: true },
    ],
    navSecondary: [
